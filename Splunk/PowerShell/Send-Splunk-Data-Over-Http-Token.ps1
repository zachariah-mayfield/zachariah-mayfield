...
–Properties "SamAccountName" -SearchBase "OU=ServiceAccounts,OU=Company,OU=Enterprise Services").SamAccountName
    ...
    Process {
        ForEach ($User in $SamAccountName) {
            ...
            IF ($LogonWorkstations -notmatch "null"){
                ...
                $event = @{event = $Object; index = 'index-name';  host = $env:computername; sourcetype = "test"} | ConvertTo-Json
                $event
