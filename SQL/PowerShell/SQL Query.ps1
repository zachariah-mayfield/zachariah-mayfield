...
$connectionString = "Server = $Server ; Database = $Database ; Trusted_Connection = $Trusted_Connection ; User Id = $UserID ;
Password = $Password ;"
...
#Out-File C:\Users\xxxxxxxxxx\Desktop\SQLQueryResult.TXT

$connection.Close()

}#END Process
END {}#END END
}# END Function Get-XXX_SQLDataBase
