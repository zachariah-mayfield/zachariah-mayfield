...
[CmdletBinding(SupportsShouldProcess=$true,ConfirmImpact='Low')]
    ...
    [String]$DataSource = "//Ip_address/Companyp",
    [Parameter()]
...
######################################################################################################################
$Command.CommandText = "SELECT * from APPS.Companyxxx
...
$KEY = ""
$User = "xxx.xxx@Company.onmicrosoft.com"
...
ForEach ($Group in $NewGroups) {
    ...
    Set-DistributionGroup -Identity $Group -ManagedBy @{Add="xxx@Company.onmicrosoft.com"} -BypassSecurityGroupManagerCheck -ErrorAction SilentlyContinue | Out-Null
}
