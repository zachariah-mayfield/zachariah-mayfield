...
Function Encrypt-Corp_Credentials {
    ...
    End {Write-Host -ForegroundColor Cyan "The UserName: " $UserName " Password has been encrypted, and stored in the file path: " $New_Password_File 
         Write-Host -ForegroundColor Cyan "it can be accessed by the AES encryption Key file: " $New_AES_File " using the Get-CDC_Credentials PS function."}
}
