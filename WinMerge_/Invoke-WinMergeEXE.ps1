Clear-Host
# Dependencies:: tools\chocolateyInstall 
# WinMerge.EXE CommandLine Example #1
# https://www.codegrepper.com/code-examples/shell/winmerge+command+line+generate+report
# WinMerge.EXE CommandLine Example #3:: Start
# $OutputFile = 'C:\xxx\xxx.csv'
# $Left_Content = 'C:\xxx\xxx\Deployment'
# $Right_Content = 'C:\xxx\xxx\Deployment'
# Invoke-WinMergeEXE -Left_Content $Left_Content -Right_Content $Right_Content -OutputFile $OutputFile
# WinMerge.EXE CommandLine Example #3:: END
# WinMerge.EXE CommandLine Manual
